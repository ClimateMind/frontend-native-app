...
// Tab Screens
import ProfileScreen from '../screens/UserAAuthorizedScreens/ProfileScreen/ProfileScreen';
import PersonalValuesScreen from '../screens/UserAAuthorizedScreens/PersonalValuesScreen/PersonalValuesScreen';
    ...
    >
      <Tabs.Screen
        ...
        options={{
          tabBarLabel: 'Profile',
          tabBarIcon: ({ color }) => (
            <Headline3 style={{ color, width: 27 }}>
